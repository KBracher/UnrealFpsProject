...
#include "FPSProject/Enemy_Controller.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FPSPROJECT_API UClass* Z_Construct_UClass_AEnemy_Controller_NoRegister();
	FPSPROJECT_API UClass* Z_Construct_UClass_AEnemy_Controller();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Controller_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AEnemy_Controller_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AEnemy_Controller()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AEnemy_Controller_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AEnemy_Controller, 1979559343);
	template<> FPSPROJECT_API UClass* StaticClass<AEnemy_Controller>()
	{
		return AEnemy_Controller::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEnemy_Controller(Z_Construct_UClass_AEnemy_Controller, &AEnemy_Controller::StaticClass, TEXT("/Script/FPSProject"), TEXT("AEnemy_Controller"), false, nullptr, nullptr, nullptr);
